...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"UPDATE `customer` SET `FirstName`='$name', `Phone`='$contactno' where `CustomerID`='".$_SESSION['id']."'");
		if($query)
		{
...
?>
					...
					<div class="form-group">
					    <label class="info-title" for="lname">Last Name<span>*</span></label>
					...
					<div class="form-group">
					    <label class="info-title" for="Contact No.">Birth Date<span>*</span></label>
